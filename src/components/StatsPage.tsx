  ...
  return (
    <>
      <div className="statsPageWrapper">
        ...
        <p>Number of times you have completed the Flags Quiz: {quizCompletionTracker?.flags}</p>
        <p>Number of times you have completed the Capitals Quiz: {quizCompletionTracker?.capitals}</p>
        <p>Number of times you have completed the Populations Quiz: {quizCompletionTracker?.population}</p>
      </div>
    </>
  );
};
