...
export function reducer(state: IQuizState, action: QuizAction): IQuizState {
  switch (action.type) {
    case "submit answer":
      return {
        ...state,
        submittedQuizAnswer: state.quizInputValue,
        quizInputValue: "",
      };
    case "next country":
      return {
    ...
    case "skip question":
      return {
        ...
        quizInputValue: "",
        incorrectAnswersArray: [
          ...state.incorrectAnswersArray,
          action.payload as CountryData,
        ],
        isAnswerCorrect: null,
        questionNumber: state.questionNumber + 1,
      };
    ...
    case "correct guess":
      return {
        ...state,
        submittedQuizAnswer: "",
        numOfCorrectAnswers: state.numOfCorrectAnswers + 1,
        correctAnswersArray: [
          ...state.correctAnswersArray,
          action.payload as CountryData,
        ],
